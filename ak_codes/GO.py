...
class Ontology(object):
    ...
    def __init__(self, filename='ak_data/go.obo', with_rels=False): #with_rels: with-relationships
        ont_dict_path = "ak_data/terms_dict.pkl"
        if osp.exists(ont_dict_path): 
            self.ont = pickle_utils.load_pickle(ont_dict_path)
        else:
            self.ont = self.load(filename, with_rels)
            pickle_utils.save_as_pickle(self.ont, ont_dict_path)
        self.ic = None
